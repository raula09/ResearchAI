...
namespace ResearchCopilot.Api.Database
{
    public class MongoContext
    {
        ...
        public MongoContext()
        {
            ...
            if (string.IsNullOrEmpty(uri) || string.IsNullOrEmpty(dbName)) throw new Exception("MongoDB environment variables not set.");
        ...
        public IMongoCollection<ChatMessage> Chat => _database.GetCollection<ChatMessage>("chat_messages");
    }
}
